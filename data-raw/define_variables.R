# plattform variables ----
spotifyQualityVars <- c('track.s.quality',
                        'track.s.firstartist.quality',
                        'track.s.album.quality',
                        'album.s.quality',
...
allVars <- unique(c(spotifyQualityVars,
                    spotifyTrackVars,
...
trackIdentifier <- c('track.s.id',
                     ...
                     'track.dz.title',
                     'track.dz.isrc',
                     'track.dz.firstartist.id',
                     'track.dz.firstartist.name',
                     'track.g.id',
                     'track.g.title',
                     'track.g.firstartist.id',
                     'track.g.firstartist.name')

artistIdentifier <- c('artist.s.id',
                      'artist.s.name',
                      'artist.mb.id',
                      'artist.mb.name',
                      'artist.dz.id',
...
releaseIdentifier <- c('album.s.id',
                       'album.s.title',
                       'album.s.upc',
                       'album.s.firstartist.id',
                       'album.s.firstartist.name',
                       ...
                       'album.dz.upc',
                       'track.dz.album.id',
                       'track.dz.album.title',
                       'track.dz.album.upc',
                       'album.dz.firstartist.id',
                       'album.dz.firstartist.name',
                       'album.dc.id',
                       'album.dc.title',
                       'album.dc.firstartist.name')

linkageVariables <- c('track.s.quality',
                     'track.s.firstartist.quality',
                     'track.s.album.quality',
                     'track.mb.foundbyisrc',
                     'track.mb.quality',
                     'track.mb.firstartist.quality',
                     'track.dz.quality',
                     'track.dz.firstartist.quality',
                     'track.dz.album.quality',
                     'track.g.quality',
                     'track.g.firstartist.quality',
                     'artist.s.quality',
                     'artist.mb.foundbyid',
                     'artist.mb.quality',
                     'artist.dz.quality',
...
labelIdentifier <- c('album.s.label',
                     'album.dz.label',
                     'track.dz.album.label')

artistDescriptors <- c('artist.mb.type',
                      'artist.mb.gender',
                      'artist.mb.area',
                      'artist.mb.origin',
                      'artist.mb.birth',
                      ...
                      'track.dz.firstartist.toptracks')

releaseDescriptors <- c('track.s.albumposition',
                        'album.s.type',
                        'album.s.totaltracks',
                        'album.s.releasedate',
                        'album.s.releaseyear',
                        'album.dz.type',
                        'album.dz.totaltracks',
                        'album.dz.releasedate',
                        'album.dz.duration',
                        'track.dz.album.type',
                        'track.dz.album.totaltracks',
                        'track.dz.album.releasedate',
                        'track.dz.album.duration')

platformHighlevelAudioDescriptors <- c('track.s.danceability',
                                      'track.s.energy',
                                      'track.s.speechiness',
                                      'track.s.acousticness',
                                      'track.s.instrumentalness',
...
audioTrackMetadata <- c('track.s.loudness',
                        'track.s.durationms',
                        'track.s.duration',
                        'track.dz.loudness',
                        'track.dz.duration')

mlHighlevelAudioClassificators <- c('track.ab.danceability',
                                    'track.ab.gender',
                                    'track.ab.acoustic',
                                    'track.ab.aggressive',
                                    'track.ab.electronic',
                                    ...
                                    'track.ab.mirex',
                                    'track.ab.timbre',
                                    'track.ab.tonalatonal',
                                    'track.ab.voiceinstrumental',
                                    'track.ab.p.danceable', 'track.ab.p.female',
                                    'track.ab.p.acoustic', 'track.ab.p.aggressive', 'track.ab.p.electronic',
                                    'track.ab.p.happy', 'track.ab.p.party', 'track.ab.p.relaxed',
                                    'track.ab.p.sad', 'track.ab.p.bright', 'track.ab.p.tonal',
                                    'track.ab.p.voice', 'track.ab.p.mirex.aggressive', 'track.ab.p.mirex.humorous',
                                    'track.ab.p.mirex.literate', 'track.ab.p.mirex.passionate', 'track.ab.p.mirex.rollicking')

mlHighlevelAudioDescriptors <- c('track.ab.rhythm.danceability',
...
aggregatedTrackLowlevelFeatures <- c()

genreDescriptors <- c('track.mb.genres',
                      'track.mb.topgenre',
                      ...
                      'album.mb.combinedgenre',
                      'album.dz.genres',
                      'album.dz.firstgenre.name',
                      'album.dz.firstgenre.id',
                      'track.dz.album.genres',
                      'track.dz.album.firstgenre.id',
...
mlGenreClassificators <- c('track.ab.genredortmund',
                           'track.ab.genreelectronic',
                           'track.ab.genrerosamerica',
                           'track.ab.genretzanetakis',
                           'track.ab.ismir04rhythm',
                           'track.ab.p.drtmd.alternative', 'track.ab.p.drtmd.blues',
                           'track.ab.p.drtmd.electronic', 'track.ab.p.drtmd.folk.country', 'track.ab.p.drtmd.funk.soul.rnb',
                           'track.ab.p.drtmd.jazz', 'track.ab.p.drtmd.pop', 'track.ab.p.drtmd.rap.hiphop',
                           'track.ab.p.drtmd.rock', 'track.ab.p.eltrc.ambient', 'track.ab.p.eltrc.drumandbass',
                           'track.ab.p.eltrc.house', 'track.ab.p.eltrc.techno', 'track.ab.p.eltrc.trance',
...
genreTags <- c('artist.s.genres',
               'artist.s.topgenre')

platformPopularity <- c('track.s.popularity',
                        'track.dz.rank',
                        'artist.s.popularity',
                        'artist.s.followers',
                        'artist.dz.followers',
...
explicitnessAndLyrics <- c('track.s.explicitlyrics',
                           ...
                           'album.dz.explicitlyricsinfo',
                           'album.dz.explicitcoverinfo',
                           'track.dz.album.explicitlyrics',
                           'track.dz.album.explicitlyricsinfo',
                           'track.dz.album.explicitcoverinfo',
                           'album.mb.language',
                           'track.g.lyricsstate',
                           'track.g.lyrics')
...
allFeatureSets <- c(trackIdentifier,
                    artistIdentifier,
                    releaseIdentifier,
                    linkageVariables,
                    labelIdentifier,
